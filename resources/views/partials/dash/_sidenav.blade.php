    ...
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header d-flex align-items-center">
        <a class="navbar-brand" href="{{ route('home') }}">
          <h2 src="" class="navbar-brand-img" alt="...">{{ config('app.name')}}</h2>
        </a>
        <div class="ml-auto">
          <!-- Sidenav toggler -->
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./listings">
              ...
              <span class="nav-link-text">User Listing</span>
          ...
          <li class="nav-item">
            <a class="nav-link" href="./index.html">
              <i class="ni ni-tv-2 text-primary"></i>
              <span class="nav-link-text">Showing Requests</span>
          ...
          <li class="nav-item">
            <a class="nav-link" href="./index.html">
              <i class="ni ni-tv-2 text-primary"></i> 
              <span class="nav-link-text">My Property</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="./index.html">
              <i class="ni ni-tv-2 text-primary"></i>
              <span class="nav-link-text">Find a Place</span>
            ...
            {{-- <li class="nav-item">
              ...
              <div class="collapse show" id="navbar-components">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="../../pages/components/cards.html" class="nav-link active">Cards</a>
                  </li>
                  <li class="nav-item">
          ...
          <hr class="my-3">
          <!-- Heading -->
          <h6 class="navbar-heading p-0 text-muted">External Links</h6>
          <!-- Navigation -->
          <ul class="navbar-nav mb-md-3">
            <li class="nav-item">
              <a class="nav-link" href="http://hacked.compeclub.com" target="_blank">
                <i class="ni ni-spaceship"></i>
                <span class="nav-link-text">HackED 2019</span>
              </a>
            </li>
          </ul>
        </div>
